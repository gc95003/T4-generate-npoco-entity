...
{
    /// <summary>
    /// Represents a T_MeetingRegForm_20190712.
    /// NOTE: 这个类是从T4模板生成的——你不应该手动修改它。
    /// </summary>
	[MetadataType(typeof(T_MeetingRegForm_20190712Metadata))]
	[PrimaryKey("")]
	[TableName("[dbo].[T_MeetingRegForm_20190712]")]
    public class T_MeetingRegForm_20190712 
    {
	    #region ResultColumn
        #endregion
        #region Ignore
		...
		private class T_MeetingRegForm_20190712Metadata{
