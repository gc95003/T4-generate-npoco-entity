...
{
    /// <summary>
    /// Represents a T_meetingRegForm_20181130.
    /// NOTE: 这个类是从T4模板生成的——你不应该手动修改它。
    /// </summary>
	[MetadataType(typeof(T_meetingRegForm_20181130Metadata))]
	[PrimaryKey("")]
	[TableName("[dbo].[T_meetingRegForm_20181130]")]
    public class T_meetingRegForm_20181130 
    {
	    #region ResultColumn
        #endregion
        #region Ignore
		...
		private class T_meetingRegForm_20181130Metadata{
