...
{
    /// <summary>
    /// Represents a Wx_AwardOption.
    /// NOTE: 这个类是从T4模板生成的——你不应该手动修改它。
    /// </summary>
	[MetadataType(typeof(Wx_AwardOptionMetadata))]
	[PrimaryKey("OptionID")]
	[TableName("[dbo].[Wx_AwardOption]")]
    public class Wx_AwardOption 
    {
	    #region ResultColumn
        #endregion
        #region Ignore
		...
		private class Wx_AwardOptionMetadata{
