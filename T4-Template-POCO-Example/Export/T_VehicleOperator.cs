...
{
    /// <summary>
    /// Represents a T_VehicleOperator.
    /// NOTE: 这个类是从T4模板生成的——你不应该手动修改它。
    /// </summary>
	[MetadataType(typeof(T_VehicleOperatorMetadata))]
	[PrimaryKey("OperatorID")]
	[TableName("[dbo].[T_VehicleOperator]")]
    public class T_VehicleOperator 
    {
	    #region ResultColumn
        #endregion
        #region Ignore
		...
		private class T_VehicleOperatorMetadata{
