...
{
    /// <summary>
    /// Represents a T_VehicleSeries.
    /// NOTE: 这个类是从T4模板生成的——你不应该手动修改它。
    /// </summary>
	[MetadataType(typeof(VehicleSeriesMetadata))]
	[PrimaryKey("SeriesID")]
	[TableName("[dbo].[T_VehicleSeries]")]
    public class T_VehicleSeries 
    {
	    #region ResultColumn
        #endregion
        #region Ignore
		...
		private class VehicleSeriesMetadata{
