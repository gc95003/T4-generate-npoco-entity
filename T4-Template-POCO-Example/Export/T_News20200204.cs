...
{
    /// <summary>
    /// Represents a T_News20200204.
    /// NOTE: 这个类是从T4模板生成的——你不应该手动修改它。
    /// </summary>
	[MetadataType(typeof(T_News20200204Metadata))]
	[PrimaryKey("")]
	[TableName("[dbo].[T_News20200204]")]
    public class T_News20200204 
    {
	    #region ResultColumn
        #endregion
        #region Ignore
		...
		private class T_News20200204Metadata{
