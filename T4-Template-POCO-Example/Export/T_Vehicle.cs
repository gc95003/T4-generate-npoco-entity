...
{
    /// <summary>
    /// Represents a T_Vehicle.
    /// NOTE: 这个类是从T4模板生成的——你不应该手动修改它。
    /// </summary>
	[MetadataType(typeof(T_VehicleMetadata))]
	[PrimaryKey("VehicleID")]
	[TableName("[dbo].[T_Vehicle]")]
    public class T_Vehicle 
    {
		...
		private class T_VehicleMetadata{
			...
			public decimal MinCompanyPrice { get; set; }

			[StringLength(5, ErrorMessage = "{0}不能超过5个字符！")]
			[Required(ErrorMessage = "请填写{0}！")]
			[Display(Name = "")]
			[Column("MaxCompanyPrice")]
			public decimal MaxCompanyPrice { get; set; }
			...
			[Display(Name = "")]
			[Column("WorkMileage")]
			public int WorkMileage { get; set; }
